        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LandLineNumber = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactInformationEntity", x => x.ContactInformationID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AddressID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AdditionalDetails = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    StreetID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
