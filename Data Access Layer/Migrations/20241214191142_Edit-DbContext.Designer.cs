...
namespace Data_Access_Layer.Migrations
{
    ...
    [Migration("20241214191142_Edit-DbContext")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core_Layer.DTOs.AuthoUser", b =>
                {
            ...
            modelBuilder.Entity("Core_Layer.Entities.Actors.AccountEntity", b =>
                {
                    b.HasOne("Core_Layer.DTOs.AuthoUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Core_Layer.DTOs.AuthoUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
