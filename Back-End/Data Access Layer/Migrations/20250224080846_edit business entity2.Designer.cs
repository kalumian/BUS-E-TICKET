...
namespace Data_Access_Layer.Migrations
{
    ...
    [Migration("20250224080846_edit business entity2")]
    partial class editbusinessentity2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core_Layer.Entities.Actors.PersonEntity", b =>
                {
                    b.HasOne("Core_Layer.Entities.ContactInformationEntity", "ContactInformation")
                        .WithOne("Person")
                        .HasForeignKey("Core_Layer.Entities.Actors.PersonEntity", "ContactInformationID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
