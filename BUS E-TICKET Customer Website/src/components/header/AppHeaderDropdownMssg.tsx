      ...
      <CDropdownMenu className="pt-0" style={{ minWidth: '24rem' }}>
        ...
        <CDropdownItem href="#">
          <div className="d-flex">
            <CAvatar className="flex-shrink-0 my-3 me-3" status="success" />
        ...
        <CDropdownItem href="#">
          <div className="d-flex">
            <CAvatar className="flex-shrink-0 my-3 me-3" status="warning" />
            <div className="message text-wrap">
        ...
        <CDropdownItem href="#">
          <div className="d-flex">
            <CAvatar className="flex-shrink-0 my-3 me-3" status="secondary" />
            <div className="message text-wrap">
              <div className="d-flex justify-content-between small text-body-secondary mt-1">
