...
// import { AddCustomer, UpdateCustomer, DeleteCustomer, GetCustomerById } from "src/Services/customerService";
import { RootState } from "src/store";
import { RegisterNewCustomer } from "src/Services/accountService";
...
const CustomerForm = () => {
    ...
    const initialPerson: Person = {
      ...
      const initialAccount: Account = {
        ...
        status: EnAccountStatus.Active  // assuming you have this enum
    };
    ...
    useEffect(() => {
        ...
        if (token && id) {
            ...
            // fetchData(() => GetCustomerById(token, id), setCustomer, setFetchError, setLoading);
        } else {
